...
; (function($) {
    ...
    $.fn.infinitescroll = function(options, callback) {
        ...
        function infscrSetup(path, opts, props, callback) {
            ...
            if (! (props.currPage <= opts.pages)) return
            //limits pages for the pager in the Views module.
            ...
            .load(path.join(props.currPage - 1) + ' ' + opts.itemSelector, null,
            function(data) {
        ...
        $(opts.localMode ? this[0] : window)
        .bind('scroll.infscr', function() {
            infscrSetup(path, opts, props, callback);
        })
        .trigger('scroll.infscr');

		$(opts.localMode ? this[0] : window)
		.bind("retrieve.infscr",function(){
			infscrSetup(path, opts, props, callback, true);
		});
    ...
    $.infinitescroll = {
        defaults: {
            ...
            // not really a selector. :) it's whatever the method was called on..
            extraScrollPx: 150,
            ...
            bufferPx: 40,
            pages: 1,
            //pages in the Drupal Views pager.
